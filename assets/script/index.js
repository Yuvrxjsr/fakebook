...
function createPostElement(userInfo, content, selectedFile) {
    ...
    postElement.innerHTML = `
        <div class="post-header">
            <img src="./assets/img/profile-img_36x36.jpeg" alt="Profile Img">
...
function getUserModalContent(userInfo) {
    return `
        <div>
            <img class="model-img" src="./assets/img/profile-img_36x36.jpeg" alt="Profile Img">
            <p>ID: ${userInfo.id}</p>
